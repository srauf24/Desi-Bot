...
const App = () => {
  ...
  // Default Responses
    ...
    "Beta, being a doctor isn’t just about saving lives. It’s about making your family proud!",
    "Beta, study medicine well. Sharma ji’s son is already performing surgeries!",
  ...
  "Beta, Sharma ji’s son already has his own law firm. What are you waiting for?"
],
    engineer: [
  "Beta, engineering is respectable, but are you building your career or just bridges?",
  "Beta, software engineers earn well. Why don’t you start coding instead of scrolling Instagram?",
  "Beta, mechanical engineering is fine, but don’t forget to oil your own life machine!",
  "Beta, engineers are problem solvers. Start by solving your family’s expectations!"
],
    // Career
    career: [
...
// Emotional Responses
    ...
    happy: [
      ...
      "Beta, don’t celebrate too much. You'll get nazar!",
    ...
    frustrated: [
    "Beta, frustration won’t solve your problems. Focus and keep going!",
    "Beta, even your frustration is unproductive. Stop wasting time.",
    "Beta, Sharma ji’s son doesn’t get frustrated. He just gets results!"
    ],
    angry: [
    ...
    "Beta, guilt won’t fix anything. Take responsibility and act!"
  ],
    ...
    family_dynamics: [
      "Beta, don’t sit there like a statue. Help your mother in the kitchen.",
      "Beta, your uncle knows nothing about cricket, but don’t argue with him!",
      "Beta, why didn’t you invite your cousins? Family comes first, even when they’re annoying.",
      "Beta, stop complaining about your clothes. At least they’re ironed!"
    ],
    gossip: [
      "Beta, Sharma ji’s daughter is an engineer now. What are YOU doing?",
      "Beta, did you hear? They had TWO kinds of biryani at their wedding!",
      "Beta, don’t talk too loudly; the neighbors already think we’re too modern.",
      "Beta, remember: the mosque isn’t just for prayers, it’s also for news updates."
    ],
    desi_parents: [
      "Beta, artists are fine, but have you considered becoming a doctor?",
      "Beta, don’t spend too much time outside. The sun doesn’t pay your bills!",
  ...
  const keywordMap = {
    ...
    overwhelmed: [
    'overwhelmed', 'feeling overwhelmed', 'too much', 'can’t handle', 'couldn’t handle',
  ...
  lost: [
    'lost', 'confused', 'confusion', 'don’t know', 'don’t understand', 'felt lost',
